...
">
        ...
        <div style="margin-top: 20px">
          <span style="margin-right: 10px">字符</span>
          <el-input style="width: 150px" v-model="extractChar"></el-input>
        </div>
        <div style="margin-top: 20px">
        ...
        <div style="margin-top: 20px">
          <span style="margin-right: 10px">几位</span>
          <el-input-number v-model="charCount" :min="1" :max="1000000000"></el-input-number>
          <!--<div>到</div>
...
<script>
    ...
    import {checkData, getDataList} from "@/api/dataDeal";
